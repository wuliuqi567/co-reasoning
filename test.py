...
if __name__ == "__main__":
    ...
    local_policy = get_II_info("co_reasoning_II")
    ...
    result1 = f"[{local_policy['delay']} {global_policy['delay']}]"
    result2 = f"[{len(local_policy['path'])} {len(global_policy['path'])}]"
    result3 = f"[{local_policy['bandwidth']} {global_policy['bandwidth']}]"
    result4 = f"[{local_policy['response_time']} {global_policy['response_time']}]"
